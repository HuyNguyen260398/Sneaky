...
DEFAULT_FILE_STORAGE = 'sneaky.aws.utils.MediaRootS3BotoStorage'
STATICFILES_STORAGE = 'sneaky.aws.utils.StaticRootS3BotoStorage'
AWS_STORAGE_BUCKET_NAME = 'sneaky-bucket'
